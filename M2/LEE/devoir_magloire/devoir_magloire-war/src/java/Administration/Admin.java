...
import entity.ResponsableFacadeLocal;
...
public class Admin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            HtmlWriter.printHeaderMenu(out);
            if (request.getParameter(AdminHtmlWriter.subLogin) != null) {
                List<Responsable> lr = responsableFacade.findAll();
                ...
                for (Responsable r : lr) {
                    if (r.getResponsablePK().getIdentifiant().equals(login)
                            && r.getResponsablePK().getMotDePasse().equals(password)) {
                        AdminHtmlWriter.printOptions(out);
                        break;
                    }
                }
